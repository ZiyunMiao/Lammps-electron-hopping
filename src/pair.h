...
class Pair : protected Pointers {
 ...
 public:
  ...
  // need for electron_hopping
  void ev_tally5(int i, int j, double evdwl, double fpair, double *virial,
                 int evflag, int vflag, int nmix, double **vatom, int inode, int jnode,
                 int **vlist);
